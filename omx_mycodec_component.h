/**
  @file src/components/vorbis/omx_mycodec_component.h
...
#ifndef _OMX_MYCODEC_COMPONENT_H_
#define _OMX_MYCODEC_COMPONENT_H_
...
// #include <mycodec/codec.h>
#include <math.h>

#define AUDIO_DEC_BASE_NAME "OMX.st.audio_decoder"
#define AUDIO_DEC_MYCODEC_NAME "OMX.st.audio_decoder.format.implementation"
#define AUDIO_DEC_MYCODEC_ROLE "audio_decoder.format"

/** MyCodec component private structure.
 */
DERIVEDCLASS(omx_mycodec_component_PrivateType, omx_base_filter_PrivateType)
#define omx_mycodec_component_PrivateType_FIELDS omx_base_filter_PrivateType_FIELDS \
  /** @param semaphore for avcodec access syncrhonization */\
  tsem_t* avCodecSyncSem; \
  /** @param pAudioVorbis Reference to OMX_AUDIO_PARAM_MYCODECTYPE structure */ \
  ...
  /* Fill out with codec-specific private variables */
  // MyCodec * codec;
  // ...
ENDCLASS(omx_mycodec_component_PrivateType)
...
OMX_ERRORTYPE omx_mycodec_component_MessageHandler(OMX_COMPONENTTYPE*,internalRequestMessageType*);
  
void omx_mycodec_component_BufferMgmtCallbackMyCodec(
